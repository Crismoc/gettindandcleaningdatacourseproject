...
## 1.1 Features names ##
setwd("C:\\Users\\Cristobal\\Dropbox\\Data Science Coursera\\3 Getting and Cleaning Data\\UCI HAR Dataset")
features <- read.table("features.txt")

## 1.2 Test data ##
setwd("C:\\Users\\Cristobal\\Dropbox\\Data Science Coursera\\3 Getting and Cleaning Data\\UCI HAR Dataset\\test")
subjecttest <- read.table("subject_test.txt")
xtest <- read.table("X_test.txt", col.names = features[,2])
ytest <- read.table("Y_test.txt")

## 1.3 Train data ##
setwd("C:\\Users\\Cristobal\\Dropbox\\Data Science Coursera\\3 Getting and Cleaning Data\\UCI HAR Dataset\\train")
